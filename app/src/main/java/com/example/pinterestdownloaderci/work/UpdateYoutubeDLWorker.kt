...
class UpdateYoutubeDLWorker(appContext: Context, params: WorkerParameters): CoroutineWorker(appContext, params) {
    ...
    override suspend fun doWork(): Result {
        try{
            ...
            val notification = NotificationCompat.Builder(applicationContext, "pinterest_update_yt_dl")
            ...
            if(result == YoutubeDL.UpdateStatus.ALREADY_UP_TO_DATE){
                val notificationDownload = NotificationCompat.Builder(applicationContext, "pinterest_update_yt_dl")
                    .setPriority(NotificationCompat.PRIORITY_MAX)
                    .setSmallIcon(R.drawable.ic_stat_pdci)
                    .setContentTitle(applicationContext.getString(R.string.update_notification_title))
                    .setStyle(
    ...
    private fun createNotificationChannel(){
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            val notificationChannel = notificationManager?.getNotificationChannel("pinterest_update_yt_dl")
            if(notificationChannel == null){
                ...
                val channel = NotificationChannel("pinterest_update_yt_dl", name, importance).apply {
