...
class DeleteWorker(appContext: Context, params: WorkerParameters): CoroutineWorker(appContext, params) {
    ...
    override suspend fun doWork(): Result {
        try{
            ...
            val notification = NotificationCompat.Builder(applicationContext, "pinterest_delete")
            ...
            if(!file.exists()){
                ...
                val notificationDelete = NotificationCompat.Builder(applicationContext, "pinterest_delete")
                    .setPriority(NotificationCompat.PRIORITY_MAX)
                    .setSmallIcon(R.drawable.ic_stat_pdci)
                    .setContentTitle(applicationContext.getString(R.string.content_deletion_notification_title))
                    .setStyle(
    ...
    private fun createNotificationChannel(){
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            val notificationChannel = notificationManager?.getNotificationChannel("pinterest_delete")
            if(notificationChannel == null){
                ...
                val channel = NotificationChannel("pinterest_delete", name, importance).apply {
