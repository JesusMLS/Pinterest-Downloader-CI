package com.example.pinterestdownloaderci.ui.settings
...
import com.example.pinterestdownloaderci.NavActivity
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import androidx.work.WorkManager
import androidx.work.workDataOf
import com.example.pinterestdownloaderci.work.UpdateYoutubeDLWorker
    ...
    private fun updateYoutubeDL(updateChannelPreference: String){
        ...
        updateScope.launch {
            try {
                ...
                val workTag = "pinterest_update_worker"
